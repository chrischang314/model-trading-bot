...
SIGNAL_CATALOG = [
    {"key": "sma_20", "label": "SMA 20", "group": "trend", "description": "Short moving average trend baseline."},
    {"key": "sma_50", "label": "SMA 50", "group": "trend", "description": "Intermediate moving average trend baseline."},
    {"key": "sma_200", "label": "SMA 200", "group": "trend", "description": "Long-term trend baseline and golden-cross reference."},
    {"key": "ema_12", "label": "EMA 12", "group": "trend", "description": "Fast EMA used in MACD."},
    {"key": "ema_26", "label": "EMA 26", "group": "trend", "description": "Slow EMA used in MACD."},
    {"key": "ema_50", "label": "EMA 50", "group": "trend", "description": "Intermediate exponential trend estimate."},
    {"key": "macd_hist", "label": "MACD Histogram", "group": "trend", "description": "Fast/slow EMA spread minus signal line."},
    {"key": "adx_14", "label": "ADX 14", "group": "trend", "description": "Trend-strength indicator based on directional movement."},
    {"key": "plus_di_14", "label": "+DI 14", "group": "trend", "description": "Positive directional movement component."},
    {"key": "minus_di_14", "label": "-DI 14", "group": "trend", "description": "Negative directional movement component."},
    {"key": "donchian_breakout", "label": "Donchian Breakout", "group": "trend", "description": "Close crossing prior 20-day channel high or low."},
    {"key": "rsi_14", "label": "RSI 14", "group": "momentum", "description": "Smoothed relative strength oscillator."},
    {"key": "stoch_k", "label": "Stochastic %K", "group": "momentum", "description": "Close location within recent high-low range."},
    {"key": "williams_r_14", "label": "Williams %R", "group": "momentum", "description": "Overbought/oversold oscillator similar to stochastic."},
    {"key": "cci_20", "label": "CCI 20", "group": "momentum", "description": "Typical-price deviation from its moving average."},
    {"key": "momentum_20d", "label": "20D Momentum", "group": "momentum", "description": "One-month rate of change."},
    {"key": "momentum_252_skip_21", "label": "12-1 Momentum", "group": "momentum", "description": "Academic-style 12-month momentum skipping the most recent month."},
    {"key": "bb_width", "label": "Bollinger Width", "group": "volatility", "description": "Normalized width of two-standard-deviation Bollinger Bands."},
    {"key": "atr_pct", "label": "ATR %", "group": "volatility", "description": "Average true range normalized by close."},
    {"key": "realized_vol_20", "label": "20D Realized Vol", "group": "volatility", "description": "Annualized standard deviation of daily returns."},
    {"key": "keltner_upper", "label": "Keltner Upper", "group": "volatility", "description": "EMA 20 plus two ATRs."},
    {"key": "keltner_lower", "label": "Keltner Lower", "group": "volatility", "description": "EMA 20 minus two ATRs."},
    {"key": "obv", "label": "OBV", "group": "volume", "description": "Cumulative signed volume."},
    {"key": "volume_z", "label": "Volume Z", "group": "volume", "description": "Volume surprise relative to the last 20 sessions."},
    {"key": "rolling_vwap_20", "label": "20D VWAP", "group": "volume", "description": "Volume-weighted rolling average of close."},
]
