...
def paper_runs(limit: int = Query(default=20, ge=1, le=50), current_user: dict = Depends(_current_user)) -> ApiEnvelope:
    return ApiEnvelope(data=auth_store.list_paper_runs(current_user["id"], limit))
